...
const Product = () => {
  ...
  // cookies().set('userid', `$`, { secure: true })
 ...
 */}
  ...
  //         <button
  //           onClick={onQuantityMinus} className="bg-blue-500 py-2 px-4 text-white rounded hover:bg-blue-600"
  //         > - </button>
  //         <input type="number" className="p-2" onChange={onInputChange} value={item.quantity}/>
  //         <button onClick={onQuantityPlus} 
  //         className="bg-blue-500 py-2 px-4 text-white rounded hover:bg-blue-600"> + </button>
  //       </div>
